  ...
  return (
    <div className="flex bg-surface text-on-background font-body min-h-screen overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto relative bg-background">
        <Header />
        <div className="p-margin-desktop max-w-5xl mx-auto space-y-gutter pb-24">
          
          <div className="flex justify-between items-center bg-surface-container-low p-6 rounded-2xl border border-outline-variant/10 shadow-sm">
            <div>
            ...
            <table className="w-full text-left">
              ...
              <tbody className="divide-y divide-outline-variant/20">
                ...
                {!loading && currentItems.length === 0 && (
                  <tr>
                    <td colSpan={3} className="px-8 py-16 text-center text-outline italic bg-surface-container-lowest/30">
