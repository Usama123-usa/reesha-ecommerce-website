  ...
  return (
    <div className="flex bg-surface text-on-background font-body min-h-screen overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto relative bg-background">
        ...
        <div className="p-4 md:p-margin-desktop max-w-6xl mx-auto space-y-gutter pb-24">
                    ...
                    <tr key={cat.id} className="hover:bg-primary-container/5 group transition-colors">
                      <td className="px-8 py-4">
                        <div className="w-14 h-14 rounded-xl overflow-hidden border border-outline-variant/20 shadow-sm">
                          <img src={cat.image_url || '/placeholder.svg'} alt={cat.name} className="w-full h-full object-cover" />
                        </div>
                      </td>
        ...
        {isModalOpen && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 overflow-y-auto">
            ...
            <div className="relative glass-panel w-full max-w-xl rounded-3xl shadow-2xl p-8 overflow-y-auto max-h-[90vh] animate-in fade-in zoom-in duration-300">
